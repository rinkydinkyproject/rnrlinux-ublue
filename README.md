...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/rinkydinkyproject/rnrlinux-ublue:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/rinkydinkyproject/rnrlinux-ublue:latest
  ```
...
```bash
cosign verify --key cosign.pub ghcr.io/rinkydinkyproject/rnrlinux-ublue
```
